    ...
    public void seed(Connection connection) {
        ...
        String sqlPerfilCampo = """ 
            INSERT INTO perfil_has_campo(perfil_idPerfil, campo_idCampo, diasPerfil) VALUES 
                        ('a061304a-9a66-4bb4-a6db-1d6b9582cdee', 'a061304a-9a66-4bb4-a6db-1d6b9582cdee', 0),
                        ()
                    ;
                """;
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sqlCampo)) {
            ...
            String[][] campos = {
                    ...
                    { "nivel", "básico" },
                    { "nivel", "profissional" },
                    { "funcionalidade", "Cadastro por E-mail e Senha" },
                    { "funcionalidade", "Cadastro pelo Facebook" },
                    ...
                    { "funcionalidade", "Sincronização em Nuvem (Cloud Syncing)" },
                    { "funcionalidade", "Dados de Sensores do Dispositivo (Device Sensor Data)" },
                    { "funcionalidade", "Códigos de Barras ou QR Codes" },
                    { "funcionalidade", "Dados de Saúde (Health Data)" },
                    { "funcionalidade", "Gerente de Projeto (Project Manager)" },
