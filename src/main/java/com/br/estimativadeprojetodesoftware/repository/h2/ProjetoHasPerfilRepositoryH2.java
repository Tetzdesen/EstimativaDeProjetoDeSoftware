...
public class ProjetoHasPerfilRepositoryH2 implements IProjetoHasPerfilRepository {

    private final Connection conexao;

    public ProjetoHasPerfilRepositoryH2() {
    ...
    public void salvar(String projetoId, String perfilId) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao adicionar relação projeto-perfil no H2: " + e.getMessage(), e);
        }
    }
    ...
    public void removerPorIds(String projetoId, String perfilId) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao remover relação projeto-perfil no H2: " + e.getMessage(), e);
        }
    }
    ...
    public List<String> buscarPerfisPorProjeto(String projetoId) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao buscar perfis por projeto no H2: " + e.getMessage(), e);
        }
        return perfis;
    }
    ...
    public List<String> buscarProjetosPorPerfil(String perfilId) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao buscar projetos por perfil no H2: " + e.getMessage(), e);
        }
        return projetos;
    }
}
